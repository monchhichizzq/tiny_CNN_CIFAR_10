...
#     y_train = utils.to_categorical(y_train, num_classes=len(classnames), dtype='float16')
#     y_test = utils.to_categorical(y_test, num_classes=len(classnames), dtype='float16')
#     print(y_test.shape)
#     print('classnames:', classnames)
#     model = cifar10_model.test_1(input_shape=(x_train.shape[1], x_train.shape[2], x_train.shape[3]), keep_prob=0.75,
#                classes=len(classnames), r=1e-2)
#
#     callbacks_list = monitoring()
#
#     adam = optimizers.adam(lr=lr_schedule(0))
#     sgd = optimizers.SGD(lr=lr_schedule(0), momentum=0.9, nesterov=False)
#
...
if __name__ == '__main__':
    ...
    # input model
    model = cifar10_model.model_88_v1(input_shape=(x_train.shape[1], x_train.shape[2], x_train.shape[3]), keep_prob=0.5,
