...
pretrained_path = 'model_save/mbv1_slim/mobilenet_slim_spikes.h5'
# pretrained_path = '../Checkpoints/mobilenet_slim_1e-06/ep_00037-valloss_27.37-closs_26.54-sloss_0.82-valacc_0.86-spikes_0.12.h5'
# pretrained_path = '../Checkpoints/mobilenet_slim_1e-06_reducelr/ep_00005-valloss_0.67-closs_0.27-sloss_0.39-valacc_0.92-spikes_0.11.h5'
# pretrained_path = '../Checkpoints/mobilenet_slim_5e-07/ep_00230-valloss_0.56-closs_0.39-sloss_0.17-valacc_92.06-spikes_0.31.h5'

tb_dir = '../Checkpoints'
log_filepath  = os.path.join(tb_dir, 'mobilenet_slim_hoyer_{}_from_scratch'.format(l1_coef))
...
mbv1 = MobileNet_V1_slim(add_spike_layer=True, count_spikes=True, add_l1_loss=True, assign_inputs=True)
