...
# from tesnorflow.keras.layers import AveragePooling2D
...
def resnet_layer(inputs,
    ...
    if conv_first:
        ...
        if SE_impl:
            x = Squeeze_excitation_layer(x, num_filters, ratio=4)
...
def resnet_v1(input_shape, depth, SE_impl = True, include_top=True, num_classes=10):
    ...
    x = resnet_layer(inputs=inputs, SE_impl=SE_impl)
...
def resnet_v3(input_shape, depth, num_classes=10):
    """ResNet Version 2 Model builder [b]
...
if __name__ == '__main__':
    ...
    # Optimizer
    adam = optimizers.adam(lr=cifar10_training.lr_schedule(0))
    ...
    callbacks_list = cifar10_training.monitoring()
