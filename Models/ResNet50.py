...
from tensorlfow.keras.layers import BatchNormalization
...
from tesnorflow.keras.models import Model



def resnet_v1(input_shape, depth, include_top=True, num_classes=10):
